...
let sampleCars: [ElectricVehicle] = [
    ...
    ElectricVehicle(id: "4", make: "Tesla", model: "Model 3 Performance", year: 2024, batteryCapacity: 82, range: 567, efficiency: 14.5, supportedChargers: [.ccs2, .type2], maxChargingSpeed: 250, image: "secret", logo: "tesla_logo"),
    ...
    ElectricVehicle(id: "6", make: "Tesla", model: "Model Y Performance", year: 2024, batteryCapacity: 75, range: 514, efficiency: 14.6, supportedChargers: [.ccs2, .type2], maxChargingSpeed: 250, image: "secret", logo: "tesla_logo"),
