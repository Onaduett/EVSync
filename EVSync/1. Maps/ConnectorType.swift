...
enum ConnectorType: String, CaseIterable {
    ...
    var icon: String {
        switch self {
        case .ccs1:      return "ev.plug.dc.ccs1.fill"
        case .ccs2:      return "ev.plug.dc.ccs2.fill"
        case .type1:     return "ev.plug.ac.type.1.fill"
        case .type2:     return "ev.plug.ac.type.2.fill"
        case .chademo:   return "ev.plug.dc.chademo.fill"
        case .gbT:       return "ev.plug.dc.gb.t.fill"
        case .tesla:     return "ev.plug.dc.nacs.fill"     // Tesla = NACS
        case .universal: return "ev.plug.ac.type.2.fill"   // универсалка = Type 2
        }
    }
